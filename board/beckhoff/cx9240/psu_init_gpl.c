...
static unsigned long psu_clock_init_data(void) {
  ...
  psu_mask_write(0xFF5E0080, 0x013F3F07U, 0x01010602U);
  ...
  psu_mask_write(0xFD1A0074, 0x013F3F07U, 0x01011803U);
  psu_mask_write(0xFD1A007C, 0x013F3F07U, 0x01012802U);
...
static unsigned long psu_ddr_init_data(void) {
  ...
  psu_mask_write(0xFD070064, 0x0FFF83FFU, 0x0020804BU);
  ...
  psu_mask_write(0xFD070120, 0x7F7F7F7FU, 0x03030404U);
  ...
  psu_mask_write(0xFD080118, 0xFFFFFFFFU, 0x000F009AU);
  psu_mask_write(0xFD08011C, 0xFFFFFFFFU, 0x82000501U);
  psu_mask_write(0xFD080120, 0xFFFFFFFFU, 0x00962B08U);
...
static unsigned long psu_mio_init_data(void) {
  ...
  psu_mask_write(0xFF180018, 0x000000FEU, 0x000000C0U);
  psu_mask_write(0xFF18001C, 0x000000FEU, 0x000000C0U);
  psu_mask_write(0xFF180020, 0x000000FEU, 0x00000040U);
  psu_mask_write(0xFF180024, 0x000000FEU, 0x00000040U);
  psu_mask_write(0xFF180028, 0x000000FEU, 0x00000040U);
  psu_mask_write(0xFF18002C, 0x000000FEU, 0x00000040U);
  ...
  psu_mask_write(0xFF180080, 0x000000FEU, 0x00000080U);
  ...
  psu_mask_write(0xFF180090, 0x000000FEU, 0x00000080U);
  psu_mask_write(0xFF180094, 0x000000FEU, 0x00000080U);
  ...
  psu_mask_write(0xFF180204, 0xFFFFFFFFU, 0x03000040U);
  psu_mask_write(0xFF180208, 0xFFFFFFFFU, 0xFC03F000U);
  psu_mask_write(0xFF18020C, 0x00003FFFU, 0x0000000BU);
  psu_mask_write(0xFF180138, 0x03FFFFFFU, 0x03FFFFFFU);
  psu_mask_write(0xFF18013C, 0x03FFFFFFU, 0x03FFFFFFU);
  psu_mask_write(0xFF180140, 0x03FFFFFFU, 0x00000000U);
  psu_mask_write(0xFF180144, 0x011F1FFFU, 0x011F1FFFU);
  psu_mask_write(0xFF180148, 0x03FFFFFFU, 0x011F1FFFU);
...
static unsigned long psu_peripherals_init_data(void) {
  ...
  psu_mask_write(0xFF5E0230, 0x00000006U, 0x00000000U);
