...
static int serdes_illcalib_pcie_gen1(u32 pllsel, u32 lane3_protocol,
  ...
  do {
    ...
    if (lane3_active == 1)
      currbistresult[3] = 0;
    serdes_rst_seq(pllsel, lane3_protocol, lane3_rate, lane2_protocol,
                   lane2_rate, lane1_protocol, lane1_rate, lane0_protocol,
                   lane0_rate);
    if (lane3_active == 1)
      serdes_bist_run(3);
    if (lane2_active == 1)
    ...
    for (loop = 0; loop <= 3; loop++) {
      ...
      if ((bistpasscount[loop] < 4) && (currbistresult[loop] == 0) &&
        ...
        if (meancountalt_bistpasscount[loop] < bistpasscount[loop]) {
          ...
          meancountalt[loop] =
              ((itercount - 1) - ((bistpasscount[loop] + 1) / 2));
        }
        bistpasscount[loop] = 0;
      }
...

{
  ...
  if (sata_gen2 == 1) {
    if (lane0_protocol == 2) {
      ...
      temp_ill12 = temp_ill12 | (Xil_In32(0xFD401990) >> 4 & 0xF);
    ...
    if (lane1_protocol == 2) {
      ...
      temp_ill12 = temp_ill12 | (Xil_In32(0xFD405990) >> 4 & 0xF);
    ...
    if (lane2_protocol == 2) {
      ...
      temp_ill12 = temp_ill12 | (Xil_In32(0xFD409990) >> 4 & 0xF);
    ...
    if (lane3_protocol == 2) {
      ...
      temp_ill12 = temp_ill12 | (Xil_In32(0xFD40D990) >> 4 & 0xF);
  ...
  if (lane0_protocol == 1) {
    if (lane0_rate == 0) {
      serdes_illcalib_pcie_gen1(0, lane3_protocol, lane3_rate, lane2_protocol,
...
static unsigned long psu_ddr_init_data(void) {
  ...
  psu_mask_write(0xFD070024, 0xFFFFFFFFU, 0x00208D55U);
  psu_mask_write(0xFD070030, 0x0000007FU, 0x00000000U);
  psu_mask_write(0xFD070034, 0x00FFFF1FU, 0x00403610U);
  psu_mask_write(0xFD070050, 0x00F1F1F4U, 0x00210000U);
  psu_mask_write(0xFD070054, 0x0FFF0FFFU, 0x00000000U);
  psu_mask_write(0xFD070060, 0x00000073U, 0x00000001U);
  psu_mask_write(0xFD070064, 0x0FFF83FFU, 0x001A8027U);
  psu_mask_write(0xFD070070, 0x00000017U, 0x00000010U);
  psu_mask_write(0xFD070074, 0x00000003U, 0x00000000U);
  psu_mask_write(0xFD0700C4, 0x3F000391U, 0x10000200U);
  psu_mask_write(0xFD0700C8, 0x01FF1F3FU, 0x0030051FU);
  psu_mask_write(0xFD0700D0, 0xC3FF0FFFU, 0x000201A2U);
  psu_mask_write(0xFD0700D4, 0x01FF7F0FU, 0x002B0000U);
  psu_mask_write(0xFD0700D8, 0x0000FF0FU, 0x00000F05U);
  ...
  psu_mask_write(0xFD070100, 0x7F3F7F3FU, 0x0C090609U);
  psu_mask_write(0xFD070104, 0x001F1F7FU, 0x0003040EU);
  ...
  psu_mask_write(0xFD070180, 0xF7FF03FFU, 0x80D60007U);
  psu_mask_write(0xFD070184, 0x3FFFFFFFU, 0x00B28B0AU);
  ...
  psu_mask_write(0xFD080018, 0xFFFFFFFFU, 0x00F03020U);
  psu_mask_write(0xFD08001C, 0xFFFFFFFFU, 0x55AA5480U);
  psu_mask_write(0xFD080024, 0xFFFFFFFFU, 0x010100F4U);
  psu_mask_write(0xFD080040, 0xFFFFFFFFU, 0x1AC0D590U);
  psu_mask_write(0xFD080044, 0xFFFFFFFFU, 0x53560780U);
  ...
  psu_mask_write(0xFD080110, 0xFFFFFFFFU, 0x05120C08U);
  psu_mask_write(0xFD080114, 0xFFFFFFFFU, 0x2812070BU);
  psu_mask_write(0xFD080118, 0xFFFFFFFFU, 0x000F0050U);
  psu_mask_write(0xFD08011C, 0xFFFFFFFFU, 0x82000501U);
  psu_mask_write(0xFD080120, 0xFFFFFFFFU, 0x004D2B08U);
  psu_mask_write(0xFD080124, 0xFFFFFFFFU, 0x001B0F08U);
  ...
  psu_mask_write(0xFD080680, 0xFFFFFFFFU, 0x00890C58U);
  ...
  psu_mask_write(0xFD080710, 0xFFFFFFFFU, 0x0E00F504U);
  ...
  psu_mask_write(0xFD080810, 0xFFFFFFFFU, 0x0E00F504U);
  ...
  psu_mask_write(0xFD081484, 0xFFFFFFFFU, 0x26124000U);
  ...
  psu_mask_write(0xFD0814C4, 0xFFFFFFFFU, 0x26124000U);
  ...
  psu_mask_write(0xFD081504, 0xFFFFFFFFU, 0x26124000U);
...
static unsigned long psu_mio_init_data(void) {
  ...
  psu_mask_write(0xFF180144, 0x001E1FFFU, 0x001E1FFFU);
  psu_mask_write(0xFF180148, 0x03FFFFFFU, 0x001E1FFFU);
  psu_mask_write(0xFF18014C, 0x03FFFFFFU, 0x00E1E000U);
  ...
  psu_mask_write(0xFF180170, 0x03FFFFFFU, 0x0300BFFFU);
  psu_mask_write(0xFF180174, 0x03FFFFFFU, 0x03FFFFFFU);
  psu_mask_write(0xFF180178, 0x03FFFFFFU, 0x00000000U);
  psu_mask_write(0xFF18017C, 0x03000FFFU, 0x03000FFFU);
  psu_mask_write(0xFF180180, 0x03FFFFFFU, 0x03000FFFU);
  psu_mask_write(0xFF180184, 0x03FFFFFFU, 0x00FF4000U);
...
static unsigned long psu_peripherals_init_data(void) {
  psu_mask_write(0xFD1A0100, 0x00000044U, 0x00000000U);
...
static unsigned long psu_serdes_init_data(void) {
  ...
  psu_mask_write(0xFD410014, 0x00000070U, 0x00000030U);
  return 1;
}
...
static int serdes_fixcal_code(void) {
  ...
  L3_TM_CALIB_DIG19 = L3_TM_CALIB_DIG19 | ((p_code & 0x3) << 6) | 0x20 | 0x4 |
                      ((n_code >> 3) & 0x3);
  ...
  L3_TM_CALIB_DIG15 = L3_TM_CALIB_DIG15 | ((r_code & 0x1) << 7) | 0x40 | 0x8 |
                      ((i_code >> 1) & 0x7);
